...
A spread short position is a more complex strategy, where users choose users borrow the asset they want to short, and swap it for a non-stable asset. The aim of such strategy is to profit from the favorable spread between the short asset and the long asset.
