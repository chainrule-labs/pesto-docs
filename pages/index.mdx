...
<div style={{ maxWidth: "450px", margin: "30px auto" }}>
	![stableShort](/stableShortDarkBg1x.png)
</div>
...
<div style={{ maxWidth: "450px", margin: "30px auto" }}>
	![spreadShort](/spreadShortDarkBg1x.png)
</div>
...
<div style={{ maxWidth: "450px", margin: "30px auto" }}>
	![stableLong](/stableLongDarkBg1x.png)
</div>
...
Each Pesto position is independent and has its own Aave account. This means that liquidation risk from one position does not affect other positions.

![indPositions](/indPositionsDarkBg1x.png)

## Where can I see the code?

On [GitHub](https://github.com/chainrule-labs/pesto-contracts).
